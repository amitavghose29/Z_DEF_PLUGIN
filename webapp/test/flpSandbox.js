		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori Launchpad Plugin for Default Value",
									"targetURL": "#comairbusdefaultpluginzdefplugin-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comairbusdefaultpluginzdefplugin-display": {
								"semanticObject": "comairbusdefaultpluginzdefplugin",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.airbus.default.plugin.zdefplugin",
									"url": sap.ui.require.toUrl("com/airbus/default/plugin/zdefplugin")
								}
							}
						}
					}
